...
const workshops = [
	...
	{
		number: 3, title: "Boolean Logic, Lists, and Recursion", outDate: "Sept. 25", active: true,
		links: [
	...
	{
		number: 5, title: "Analysis, Lambda Expressions, and HOPs", outDate: "Oct. 9-10", active: true,
		links: [
